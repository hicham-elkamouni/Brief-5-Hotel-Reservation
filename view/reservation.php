                ...
                <form class="needs-validation">
                    <div class="row g-3">
                        <div class="col-sm-6">
                            ...
                            <input type="date" class="form-control" id="checkInDate" name="checkInDate" placeholder="" value="" required>
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="date" class="form-control" id="checkOutDate" name="checkOutDate" placeholder="" value="" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-sm-6">
                            ...
                            <select class="form-select form-control" name="localType" id="localType" required>
